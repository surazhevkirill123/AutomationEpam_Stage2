package ioFundamentals.optionalTask.run;

import ioFundamentals.optionalTask.javaProgram.JavaProgramModifier;
import ioFundamentals.optionalTask.javaProgram.Reader;
import ioFundamentals.optionalTask.javaProgram.Writer;
import ioFundamentals.optionalTask.randomNumbers.RandomNumbersContainer;
import ioFundamentals.optionalTask.randomNumbers.RandomNumbersReader;
import ioFundamentals.optionalTask.randomNumbers.RandomNumbersWriter;

import java.util.Scanner;

public class Executor {
    final static String FILES_ROOT_PATH = "src/test/java/ioFundamentals/optionalTask/resources/";
