...
public class GoogleCloudTest extends AbstractTest {
    ...
    @Test(description = "Check if submitted VMClass value matches initial value")
    ...
    @Test(description = "Check if submitted Instance type matches initial value")
    ...
    @Test(description = "Check if submitted Region matches initial value")
    ...
    @Test(description = "Check if submitted Local SSD matches initial value")
    ...
    @Test(description = "Check if submitted CommitmentTerm matches initial value")
    ...
    @Test(description = "Check if submitted TotalCost matches initial value")
